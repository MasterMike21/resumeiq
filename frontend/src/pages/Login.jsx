...
export default function Login() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 bg-slate-50 dark:bg-slate-950 transition-colors duration-200">
      <div className="max-w-md w-full space-y-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-2xl shadow-xl">
        <div>
          <div className="mx-auto h-12 w-12 bg-indigo-50 dark:bg-indigo-950/60 flex items-center justify-center rounded-xl text-indigo-600 dark:text-indigo-400">
            <LogIn size={26} />
          </div>
          <h2 className="mt-4 text-center text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Welcome back</h2>
        </div>

        {error && <div className="bg-rose-50 dark:bg-rose-950/40 border border-rose-200 text-rose-600 text-sm px-4 py-3 rounded-xl">{error}</div>}
